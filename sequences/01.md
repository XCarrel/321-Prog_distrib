# Travail effectué par FID2, semaine du 12.1.2026
...
- Voir le projet fil rouge [PowerCher](https://github.com/ETML-INF/powercher)
...
- Vous forkez PowerCher, vous dupliquez la maison en `HouseUI-XXX` et vous ne touchez qu'à cette maison par la suite
...
Mise oeuvre d'un bus de message avec [MQTT](https://github.com/XCarrel/321-Prog_distrib/blob/main/thematiques/04-MQTT.md)

- Broker local avec Docker
- Broker commun `mqtt.blue.section-inf.ch`
- Client MQTTX ou MQTT Explorer

Installation de vos PowerCher forkés. Validation avec MQTTX (capture du message HELLO)
...
On a découvert la base de code de Powercher, mis en place les containers pour le MQTT broker
